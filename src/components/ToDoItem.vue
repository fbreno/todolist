<template>
    ...
    <to-do-item-edit-form
        ...
        :id="id"
        :label="label"
        @item-editado="itemEditado"
        @edicao-cancelada="edicaoCancelada"></to-do-item-edit-form>
</template>
...
export default {
    ...
    methods: {
        deleteToDo() {
            this.$emit("item-excluido");
        },
        toggleToItemEditForm() {
            console.log(this.$refs.editButton);
            this.isEditing = true;
        },
        itemEditado(newLabel) {
            this.$emit("item-editado", newLabel);
